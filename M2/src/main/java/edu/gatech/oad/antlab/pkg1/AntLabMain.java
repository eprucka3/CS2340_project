 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person1 p1 = new Person1("Anish Iyer");
		  toPrint += p1.toString("aiyer76");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Ilya");
		  toPrint += p2.toString("903301260");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Liz");
		  toPrint += p3.toString("eprucka3");
